...
namespace FormRecognizerQuickStart
{
    class Program
    {
        ...
        private static string subscriptionKey = "eff4a77225ca400ab1d6b69f2d66940a";/*Environment.GetEnvironmentVariable("FORM_RECOGNIZER_SUBSCRIPTION_KEY");*/
        private static string formRecognizerEndpoint = @"https://adcbformrecognizer.cognitiveservices.azure.com";/*Environment.GetEnvironmentVariable("FORM_RECOGNIZER_ENDPOINT");*/

        // SAS Url to Azure Blob Storage container; this used for training the custom model
        // For help using SAS see: 
        // https://docs.microsoft.com/en-us/azure/storage/common/storage-dotnet-shared-access-signature-part-1
        private const string trainingDataUrl = @"https://signaturestorageacct.blob.core.windows.net/chequestorage?sv=2019-12-12&ss=bfqt&srt=sco&sp=rwdlacupx&se=2020-11-16T17:17:41Z&st=2020-11-16T09:17:41Z&spr=https&sig=JENEUJdlS2N0%2FtsTdJIoiGQQRHt2%2B4X1ZJk92VOqxps%3D";
        ...
        private static async Task AnalyzeJpgForm(IFormRecognizerClient formClient, Guid modelId, string jpgFormFile)
        {
        ...
        private static async Task AnalyzePngForm(IFormRecognizerClient formClient, Guid modelId, string pngFormFile)
        {
